import { App, Component, div, p, commandButton, slider, a } from 'pickle-ts'
...
export class Relativity extends Component
{
  ...
  view() { 
    ...
    return (
      div({ style: { textAlign: "center" } },
        ...
        slider(() => this.speedPercent, 0, 99, 1, e => this.updateProperty(e), { style: { width: "500px" } }),
  ...
  simulate() {
     if (this.parent!["current"] != "relativity") {
       this.on = false
       return
    }
